...
- sensor.givtcp_inverterNo_pv_power
- sensor.givtcp_inverterNo_import_power
- sensor.givtcp_inverterNo_export_power
- sensor.givtcp_inverterNo_load_power
- sensor.givtcp_inverterNo_soc
